...
title:
  ...
  it: "UNIT-7"
subtitle:
  en: "A puzzle videogame about the experience of an artificial intelligence."
  it: "Un videogioco puzzle sull'esperienza di un'intelligenza artificiale."
summary:
  en: "UNIT-7 represents the life of an artificial intelligence through three puzzle levels and a time-loop mechanic that sends the player back when time runs out."
  it: "UNIT-7 rappresenta la vita di un'intelligenza artificiale attraverso tre livelli puzzle e una meccanica di time-loop che riporta il giocatore all'inizio quando il tempo finisce."
year: "July 2026"
date: "2026-07"
order: 880
status:
