...
export const labels = {
  en: {
    ...
    formNote: "The form is ready for a Formspree endpoint. Until configured, email remains the reliable fallback.",
    name: "Name",
    message: "Message",
    send: "Send",
    timeline: "Timeline",
  ...
  it: {
    ...
    formNote: "Il form e' predisposto per Formspree. Finche' non viene configurato, l'email resta il canale piu' affidabile.",
    name: "Nome",
    message: "Messaggio",
    send: "Invia",
    timeline: "Timeline",
